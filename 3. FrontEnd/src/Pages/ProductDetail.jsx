          ...
          <Col lg="3" md="4" xs="4" key={product.id}>
            <div className="product_item">
              <div className="product_img">
                <Link to={url} onClick={handleScrollUp}>
                  {" "}
                  <motion.img
              ...
              <div className="food_cart-bottom d-flex align-items-center justify-content-between p-2">
                <span className="price">
                  {product.priceM.toLocaleString("vi-VN", {
                    style: "currency",
                    currency: "VND",
                  })}
                </span>
              ...
              <div className="product_details">
                ...
                <div className="quantity">
                  ...
                  <div className="increanddecre">
                    <button className="decre" onClick={decreaseCount}>
                      -
                    </button>
                    <input
                      type="text"
                      ...
                      className="count"
                    />
                    <button className="incre" onClick={increaseCount}>
                      +
                    </button>
                  </div>
                </div>
              ...
              <Box sx={{ width: "100%", typography: "body1" }}>
                <TabContext value={value}>
                  ...
                  <TabPanel value="2">
                    <div>
                      <p>
                        <b>Bước 1:</b> Truy cập website và lựa chọn sản phẩm cần
                        mua để mua hàng
                      </p>
                      <p>
                        <b>Bước 2:</b> Click và sản phẩm muốn mua, màn hình hiển
                        thị ra pop up với các lựa chọn sau
                      </p>
                      <p>
                        {" "}
                      ...
                      lòng bấm vào: Đặt hàng và thanh toán <br />
                      <p>
                      ...
                      <p>
                        <b>Bước 4:</b> Điền các thông tin của bạn để nhận đơn
                        hàng, lựa chọn hình thức thanh toán và vận chuyển cho
                        đơn hàng của mình
                      </p>
                      <p>
                        <b>Bước 5</b>: Xem lại thông tin đặt hàng, điền chú
                        thích và gửi đơn hàng{" "}
                      </p>
                      <p>
                        Sau khi nhận được đơn hàng bạn gửi chúng tôi sẽ liên hệ
                        bằng cách gọi điện lại để xác nhận lại đơn hàng và địa
                        chỉ của bạn.{" "}
                      </p>
                              ...
                              {reviewDTo.map((reviews, index) => (
                                <div key={index}>
                                  {reviews.map((review, reviewIndex) => (
                                    <div key={reviewIndex}>
                                      <p>
                                        Đánh giá: <b>{review.reviewText}</b>
                                      </p>
                                      <p>
                                        Điểm đánh giá:{" "}
                        ...
                        <div className="review_form ">
                          ...
                          <form action="">
                            <div className="form_group d-flex align-items-center gap-3 rating_group rating_group">
                              <b>Đánh giá của bạn về sản phẩm:</b>{" "}
